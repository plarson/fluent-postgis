    ...
    Database.QueryFilterValue == Database.QueryFilter
{
    ...
    @discardableResult
    public func filterGeometryWithin<T>(_ key: KeyPath<Result, T>, _ filter: PostGISGeometry) -> Self
    ...
    /// - returns: Query builder for chaining.
    @discardableResult
    public func filterGeometryWithin<T>(_ value: PostGISGeometry, _ key: KeyPath<Result, T>) -> Self
        where T: PostGISGeometry
    {
